...
class TestGtfsStaticUtil(testutil.TestCase(gtfsstaticutil), unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.genericqueries.get_id_to_pk_map = lambda model_type: self.get_id_to_pk_map[model_type]
    ...
    def test_parse_gtfs_static(self, GtfsStaticData, _fast_insert, _create_station):
        ...
        all_feed_stops = [
            grandchild_1, grandchild_2, grandchild_3, grandchild_4,
        ...
        gtfs_static_data.stop_id_to_stop = {
            stop.id: stop for stop in all_feed_stops
        }
    ...
    def test_create_station_from_child_stops_hybrid_name(self):
        ...
        actual_station = gtfsstaticutil._create_station_from_child_stops([child_1, child_2])
    ...
    def test_parse_routes(self):
        ...
        self._set_gtfs_static_file_data(
            gtfsstaticutil.GtfsStaticFile.ROUTES, [data])
    ...
    def test_parse_stops__station(self):
        ...
        self._set_gtfs_static_file_data(
            gtfsstaticutil.GtfsStaticFile.STOPS, [data])
    ...
    def test_parse_services(self):
        ...
        gtfsstaticutil.fast_scheduled_entities_insert(
            mock.MagicMock(), self.system)
    ...
    def test_parse_scheduled_trips(self):
        ...
        self._set_gtfs_static_file_data(
            gtfsstaticutil.GtfsStaticFile.TRIPS, [raw_data])
    ...
    def test_parse_scheduled_trip_stop_times(self):
        ...
        self.get_id_to_pk_map[models.ScheduledTrip] = {
            self.TRIP_ID: self.TRIP_PK
        }
...
class TestReadZipFile(unittest.TestCase):
    ...
    def test_file_exists(self):
        ...
        actual = list(gtfsstaticutil.read_gtfs_static_file(
