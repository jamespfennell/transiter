...
def stop_1_1(add_model, system_1):
    return add_model(
        models.Stop(pk=101, id="102", system=system_1, type=models.Stop.Type.STATION)
    )
...
def stop_1_2(add_model, system_1):
    return add_model(
        models.Stop(pk=103, id="104", system=system_1, type=models.Stop.Type.STATION)
    )
...
def stop_1_5(add_model, system_1):
    return add_model(
        models.Stop(pk=109, id="110", system=system_1, type=models.Stop.Type.STATION)
    )
...
def stop_2_1(add_model, system_2):
    return add_model(
        models.Stop(pk=111, id="112", system=system_2, type=models.Stop.Type.PLATFORM)
    )
