...
| href | string | URL of the endpoint to list child resources. This is populated if the `X-Transiter-Host` HTTP header is provided in the request. See [the deployment documentation](../deployment.md#optional-setting-the-transiter-host) for more information.
...
| href | string | URL of the resource. This is populated if the `X-Transiter-Host` HTTP header is provided in the request. See [the deployment documentation](../deployment.md#optional-setting-the-transiter-host) for more information about this header.
