...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "built_in_parser",
            sa.Enum("GTFS_STATIC", "GTFS_REALTIME", name="builtinparser"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "source",
            sa.Enum("SCHEDULE", "REALTIME", name="servicemapsource"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "update_type",
            sa.Enum("REGULAR", "FLUSH", name="update_type"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("SCHEDULED", "IN_PROGRESS", "SUCCESS", "FAILURE", name="status"),
            nullable=True,
        ),
        sa.Column(
            "explanation",
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "trip_stop_time_stop_pk_arrival_time_idx", table_name="trip_stop_time"
    )
    op.drop_table("trip_stop_time")
    op.drop_index("service_map_vertex_map_pk_position", table_name="service_map_vertex")
    op.drop_table("service_map_vertex")
    op.drop_index(
        "scheduled_trip_stop_time_trip_pk_departure_time_idx",
        table_name="scheduled_trip_stop_time",
    )
    op.drop_table("scheduled_trip_stop_time")
    op.drop_index(op.f("ix_trip_source_pk"), table_name="trip")
    op.drop_table("trip")
    op.drop_index(op.f("ix_service_map_route_pk"), table_name="service_map")
    op.drop_table("service_map")
    op.drop_table("scheduled_trip")
    op.drop_index(
        op.f("ix_direction_name_rule_source_pk"), table_name="direction_name_rule"
    )
    op.drop_index(
        "direction_name_rule_stop_pk_priority_idx", table_name="direction_name_rule"
    )
    op.drop_table("direction_name_rule")
    op.drop_index(op.f("ix_alert_route_route_pk"), table_name="alert_route")
    op.drop_table("alert_route")
    op.drop_index(op.f("ix_stop_source_pk"), table_name="stop")
    op.drop_index(op.f("ix_stop_parent_stop_pk"), table_name="stop")
    op.drop_table("stop")
    op.drop_index(
        op.f("ix_scheduled_service_system_pk"), table_name="scheduled_service"
    )
    op.drop_index(
        op.f("ix_scheduled_service_source_pk"), table_name="scheduled_service"
    )
    op.drop_table("scheduled_service")
    op.drop_index(op.f("ix_route_source_pk"), table_name="route")
    op.drop_table("route")
    op.drop_index(op.f("ix_alert_system_pk"), table_name="alert")
    op.drop_index(op.f("ix_alert_source_pk"), table_name="alert")
    op.drop_table("alert")
    op.drop_index(op.f("ix_feed_update_last_action_time"), table_name="feed_update")
    op.drop_index("feed_updates_last_successful_idx", table_name="feed_update")
    op.drop_table("feed_update")
    op.drop_table("service_map_group")
    op.drop_table("feed")
