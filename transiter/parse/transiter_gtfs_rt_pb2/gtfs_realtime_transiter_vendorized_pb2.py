...
# source: gtfs-realtime-transiter-vendorized.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="gtfs-realtime-transiter-vendorized.proto",
    package="gtfs_realtime_transiter_vendorized",
    syntax="proto2",
    serialized_options=_b("\n\033com.google.transit.realtime"),
    serialized_pb=_b(
        '\n(gtfs-realtime-transiter-vendorized.proto\x12"gtfs_realtime_transiter_vendorized"\x9d\x01\n\x0b\x46\x65\x65\x64Message\x12>\n\x06header\x18\x01 \x02(\x0b\x32..gtfs_realtime_transiter_vendorized.FeedHeader\x12>\n\x06\x65ntity\x18\x02 \x03(\x0b\x32..gtfs_realtime_transiter_vendorized.FeedEntity*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"\xe9\x01\n\nFeedHeader\x12\x1d\n\x15gtfs_realtime_version\x18\x01 \x02(\t\x12\x63\n\x0eincrementality\x18\x02 \x01(\x0e\x32=.gtfs_realtime_transiter_vendorized.FeedHeader.Incrementality:\x0c\x46ULL_DATASET\x12\x11\n\ttimestamp\x18\x03 \x01(\x04"4\n\x0eIncrementality\x12\x10\n\x0c\x46ULL_DATASET\x10\x00\x12\x10\n\x0c\x44IFFERENTIAL\x10\x01*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"\x88\x02\n\nFeedEntity\x12\n\n\x02id\x18\x01 \x02(\t\x12\x19\n\nis_deleted\x18\x02 \x01(\x08:\x05\x66\x61lse\x12\x43\n\x0btrip_update\x18\x03 \x01(\x0b\x32..gtfs_realtime_transiter_vendorized.TripUpdate\x12\x44\n\x07vehicle\x18\x04 \x01(\x0b\x32\x33.gtfs_realtime_transiter_vendorized.VehiclePosition\x12\x38\n\x05\x61lert\x18\x05 \x01(\x0b\x32).gtfs_realtime_transiter_vendorized.Alert*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"\xaf\x06\n\nTripUpdate\x12@\n\x04trip\x18\x01 \x02(\x0b\x32\x32.gtfs_realtime_transiter_vendorized.TripDescriptor\x12\x46\n\x07vehicle\x18\x03 \x01(\x0b\x32\x35.gtfs_realtime_transiter_vendorized.VehicleDescriptor\x12W\n\x10stop_time_update\x18\x02 \x03(\x0b\x32=.gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeUpdate\x12\x11\n\ttimestamp\x18\x04 \x01(\x04\x12\r\n\x05\x64\x65lay\x18\x05 \x01(\x05\x1aQ\n\rStopTimeEvent\x12\r\n\x05\x64\x65lay\x18\x01 \x01(\x05\x12\x0c\n\x04time\x18\x02 \x01(\x03\x12\x13\n\x0buncertainty\x18\x03 \x01(\x05*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N\x1a\xb8\x03\n\x0eStopTimeUpdate\x12\x15\n\rstop_sequence\x18\x01 \x01(\r\x12\x0f\n\x07stop_id\x18\x04 \x01(\t\x12M\n\x07\x61rrival\x18\x02 \x01(\x0b\x32<.gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeEvent\x12O\n\tdeparture\x18\x03 \x01(\x0b\x32<.gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeEvent\x12|\n\x15schedule_relationship\x18\x05 \x01(\x0e\x32R.gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeUpdate.ScheduleRelationship:\tSCHEDULED"P\n\x14ScheduleRelationship\x12\r\n\tSCHEDULED\x10\x00\x12\x0b\n\x07SKIPPED\x10\x01\x12\x0b\n\x07NO_DATA\x10\x02\x12\x0f\n\x0bUNSCHEDULED\x10\x03*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"\xf2\x07\n\x0fVehiclePosition\x12@\n\x04trip\x18\x01 \x01(\x0b\x32\x32.gtfs_realtime_transiter_vendorized.TripDescriptor\x12\x46\n\x07vehicle\x18\x08 \x01(\x0b\x32\x35.gtfs_realtime_transiter_vendorized.VehicleDescriptor\x12>\n\x08position\x18\x02 \x01(\x0b\x32,.gtfs_realtime_transiter_vendorized.Position\x12\x1d\n\x15\x63urrent_stop_sequence\x18\x03 \x01(\r\x12\x0f\n\x07stop_id\x18\x07 \x01(\t\x12l\n\x0e\x63urrent_status\x18\x04 \x01(\x0e\x32\x45.gtfs_realtime_transiter_vendorized.VehiclePosition.VehicleStopStatus:\rIN_TRANSIT_TO\x12\x11\n\ttimestamp\x18\x05 \x01(\x04\x12]\n\x10\x63ongestion_level\x18\x06 \x01(\x0e\x32\x43.gtfs_realtime_transiter_vendorized.VehiclePosition.CongestionLevel\x12]\n\x10occupancy_status\x18\t \x01(\x0e\x32\x43.gtfs_realtime_transiter_vendorized.VehiclePosition.OccupancyStatus\x12\x1c\n\x14occupancy_percentage\x18\n \x01(\r"G\n\x11VehicleStopStatus\x12\x0f\n\x0bINCOMING_AT\x10\x00\x12\x0e\n\nSTOPPED_AT\x10\x01\x12\x11\n\rIN_TRANSIT_TO\x10\x02"}\n\x0f\x43ongestionLevel\x12\x1c\n\x18UNKNOWN_CONGESTION_LEVEL\x10\x00\x12\x14\n\x10RUNNING_SMOOTHLY\x10\x01\x12\x0f\n\x0bSTOP_AND_GO\x10\x02\x12\x0e\n\nCONGESTION\x10\x03\x12\x15\n\x11SEVERE_CONGESTION\x10\x04"\xaf\x01\n\x0fOccupancyStatus\x12\t\n\x05\x45MPTY\x10\x00\x12\x18\n\x14MANY_SEATS_AVAILABLE\x10\x01\x12\x17\n\x13\x46\x45W_SEATS_AVAILABLE\x10\x02\x12\x16\n\x12STANDING_ROOM_ONLY\x10\x03\x12\x1e\n\x1a\x43RUSHED_STANDING_ROOM_ONLY\x10\x04\x12\x08\n\x04\x46ULL\x10\x05\x12\x1c\n\x18NOT_ACCEPTING_PASSENGERS\x10\x06*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"\xb4\n\n\x05\x41lert\x12\x44\n\ractive_period\x18\x01 \x03(\x0b\x32-.gtfs_realtime_transiter_vendorized.TimeRange\x12K\n\x0finformed_entity\x18\x05 \x03(\x0b\x32\x32.gtfs_realtime_transiter_vendorized.EntitySelector\x12M\n\x05\x63\x61use\x18\x06 \x01(\x0e\x32/.gtfs_realtime_transiter_vendorized.Alert.Cause:\rUNKNOWN_CAUSE\x12P\n\x06\x65\x66\x66\x65\x63t\x18\x07 \x01(\x0e\x32\x30.gtfs_realtime_transiter_vendorized.Alert.Effect:\x0eUNKNOWN_EFFECT\x12\x41\n\x03url\x18\x08 \x01(\x0b\x32\x34.gtfs_realtime_transiter_vendorized.TranslatedString\x12I\n\x0bheader_text\x18\n \x01(\x0b\x32\x34.gtfs_realtime_transiter_vendorized.TranslatedString\x12N\n\x10\x64\x65scription_text\x18\x0b \x01(\x0b\x32\x34.gtfs_realtime_transiter_vendorized.TranslatedString\x12M\n\x0ftts_header_text\x18\x0c \x01(\x0b\x32\x34.gtfs_realtime_transiter_vendorized.TranslatedString\x12R\n\x14tts_description_text\x18\r \x01(\x0b\x32\x34.gtfs_realtime_transiter_vendorized.TranslatedString\x12\x61\n\x0eseverity_level\x18\x0e \x01(\x0e\x32\x37.gtfs_realtime_transiter_vendorized.Alert.SeverityLevel:\x10UNKNOWN_SEVERITY"\xd8\x01\n\x05\x43\x61use\x12\x11\n\rUNKNOWN_CAUSE\x10\x01\x12\x0f\n\x0bOTHER_CAUSE\x10\x02\x12\x15\n\x11TECHNICAL_PROBLEM\x10\x03\x12\n\n\x06STRIKE\x10\x04\x12\x11\n\rDEMONSTRATION\x10\x05\x12\x0c\n\x08\x41\x43\x43IDENT\x10\x06\x12\x0b\n\x07HOLIDAY\x10\x07\x12\x0b\n\x07WEATHER\x10\x08\x12\x0f\n\x0bMAINTENANCE\x10\t\x12\x10\n\x0c\x43ONSTRUCTION\x10\n\x12\x13\n\x0fPOLICE_ACTIVITY\x10\x0b\x12\x15\n\x11MEDICAL_EMERGENCY\x10\x0c"\xdd\x01\n\x06\x45\x66\x66\x65\x63t\x12\x0e\n\nNO_SERVICE\x10\x01\x12\x13\n\x0fREDUCED_SERVICE\x10\x02\x12\x16\n\x12SIGNIFICANT_DELAYS\x10\x03\x12\n\n\x06\x44\x45TOUR\x10\x04\x12\x16\n\x12\x41\x44\x44ITIONAL_SERVICE\x10\x05\x12\x14\n\x10MODIFIED_SERVICE\x10\x06\x12\x10\n\x0cOTHER_EFFECT\x10\x07\x12\x12\n\x0eUNKNOWN_EFFECT\x10\x08\x12\x0e\n\nSTOP_MOVED\x10\t\x12\r\n\tNO_EFFECT\x10\n\x12\x17\n\x13\x41\x43\x43\x45SSIBILITY_ISSUE\x10\x0b"H\n\rSeverityLevel\x12\x14\n\x10UNKNOWN_SEVERITY\x10\x01\x12\x08\n\x04INFO\x10\x02\x12\x0b\n\x07WARNING\x10\x03\x12\n\n\x06SEVERE\x10\x04*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"7\n\tTimeRange\x12\r\n\x05start\x18\x01 \x01(\x04\x12\x0b\n\x03\x65nd\x18\x02 \x01(\x04*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"q\n\x08Position\x12\x10\n\x08latitude\x18\x01 \x02(\x02\x12\x11\n\tlongitude\x18\x02 \x02(\x02\x12\x0f\n\x07\x62\x65\x61ring\x18\x03 \x01(\x02\x12\x10\n\x08odometer\x18\x04 \x01(\x01\x12\r\n\x05speed\x18\x05 \x01(\x02*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"\xcf\x02\n\x0eTripDescriptor\x12\x0f\n\x07trip_id\x18\x01 \x01(\t\x12\x10\n\x08route_id\x18\x05 \x01(\t\x12\x14\n\x0c\x64irection_id\x18\x06 \x01(\r\x12\x12\n\nstart_time\x18\x02 \x01(\t\x12\x12\n\nstart_date\x18\x03 \x01(\t\x12\x66\n\x15schedule_relationship\x18\x04 \x01(\x0e\x32G.gtfs_realtime_transiter_vendorized.TripDescriptor.ScheduleRelationship"d\n\x14ScheduleRelationship\x12\r\n\tSCHEDULED\x10\x00\x12\t\n\x05\x41\x44\x44\x45\x44\x10\x01\x12\x0f\n\x0bUNSCHEDULED\x10\x02\x12\x0c\n\x08\x43\x41NCELED\x10\x03\x12\x13\n\x0bREPLACEMENT\x10\x05\x1a\x02\x08\x01*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"U\n\x11VehicleDescriptor\x12\n\n\x02id\x18\x01 \x01(\t\x12\r\n\x05label\x18\x02 \x01(\t\x12\x15\n\rlicense_plate\x18\x03 \x01(\t*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"\xc2\x01\n\x0e\x45ntitySelector\x12\x11\n\tagency_id\x18\x01 \x01(\t\x12\x10\n\x08route_id\x18\x02 \x01(\t\x12\x12\n\nroute_type\x18\x03 \x01(\x05\x12@\n\x04trip\x18\x04 \x01(\x0b\x32\x32.gtfs_realtime_transiter_vendorized.TripDescriptor\x12\x0f\n\x07stop_id\x18\x05 \x01(\t\x12\x14\n\x0c\x64irection_id\x18\x06 \x01(\r*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N"\xb8\x01\n\x10TranslatedString\x12U\n\x0btranslation\x18\x01 \x03(\x0b\x32@.gtfs_realtime_transiter_vendorized.TranslatedString.Translation\x1a=\n\x0bTranslation\x12\x0c\n\x04text\x18\x01 \x02(\t\x12\x10\n\x08language\x18\x02 \x01(\t*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90N*\x06\x08\xe8\x07\x10\xd0\x0f*\x06\x08\xa8\x46\x10\x90NB\x1d\n\x1b\x63om.google.transit.realtime'
    ),
)
...
_FEEDHEADER_INCREMENTALITY = _descriptor.EnumDescriptor(
    name="Incrementality",
    full_name="gtfs_realtime_transiter_vendorized.FeedHeader.Incrementality",
    filename=None,
    file=DESCRIPTOR,
    values=[
...
_TRIPUPDATE_STOPTIMEUPDATE_SCHEDULERELATIONSHIP = _descriptor.EnumDescriptor(
    ...
    full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeUpdate.ScheduleRelationship",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_VEHICLEPOSITION_VEHICLESTOPSTATUS = _descriptor.EnumDescriptor(
    ...
    full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.VehicleStopStatus",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_VEHICLEPOSITION_CONGESTIONLEVEL = _descriptor.EnumDescriptor(
    ...
    full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.CongestionLevel",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_VEHICLEPOSITION_OCCUPANCYSTATUS = _descriptor.EnumDescriptor(
    ...
    full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.OccupancyStatus",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_ALERT_CAUSE = _descriptor.EnumDescriptor(
    name="Cause",
    full_name="gtfs_realtime_transiter_vendorized.Alert.Cause",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_ALERT_EFFECT = _descriptor.EnumDescriptor(
    name="Effect",
    full_name="gtfs_realtime_transiter_vendorized.Alert.Effect",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_ALERT_SEVERITYLEVEL = _descriptor.EnumDescriptor(
    name="SeverityLevel",
    full_name="gtfs_realtime_transiter_vendorized.Alert.SeverityLevel",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_TRIPDESCRIPTOR_SCHEDULERELATIONSHIP = _descriptor.EnumDescriptor(
    name="ScheduleRelationship",
    full_name="gtfs_realtime_transiter_vendorized.TripDescriptor.ScheduleRelationship",
    filename=None,
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(
...
_FEEDMESSAGE = _descriptor.Descriptor(
    name="FeedMessage",
    full_name="gtfs_realtime_transiter_vendorized.FeedMessage",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="header",
            full_name="gtfs_realtime_transiter_vendorized.FeedMessage.header",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="entity",
            full_name="gtfs_realtime_transiter_vendorized.FeedMessage.entity",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_FEEDHEADER = _descriptor.Descriptor(
    name="FeedHeader",
    full_name="gtfs_realtime_transiter_vendorized.FeedHeader",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.FeedHeader.gtfs_realtime_version",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="gtfs_realtime_transiter_vendorized.FeedHeader.timestamp",
            index=2,
            number=3,
            type=4,
            cpp_type=4,
...
_FEEDENTITY = _descriptor.Descriptor(
    name="FeedEntity",
    full_name="gtfs_realtime_transiter_vendorized.FeedEntity",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="gtfs_realtime_transiter_vendorized.FeedEntity.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="is_deleted",
            full_name="gtfs_realtime_transiter_vendorized.FeedEntity.is_deleted",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="trip_update",
            full_name="gtfs_realtime_transiter_vendorized.FeedEntity.trip_update",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="vehicle",
            full_name="gtfs_realtime_transiter_vendorized.FeedEntity.vehicle",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="alert",
            full_name="gtfs_realtime_transiter_vendorized.FeedEntity.alert",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
_TRIPUPDATE_STOPTIMEEVENT = _descriptor.Descriptor(
    name="StopTimeEvent",
    full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeEvent",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="delay",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeEvent.delay",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="time",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeEvent.time",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="uncertainty",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeEvent.uncertainty",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_TRIPUPDATE_STOPTIMEUPDATE = _descriptor.Descriptor(
    name="StopTimeUpdate",
    full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeUpdate",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="stop_sequence",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeUpdate.stop_sequence",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="stop_id",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeUpdate.stop_id",
            index=1,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="arrival",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeUpdate.arrival",
            index=2,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="departure",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeUpdate.departure",
            index=3,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeUpdate.schedule_relationship",
            index=4,
            number=5,
            type=14,
            cpp_type=8,
...
_TRIPUPDATE = _descriptor.Descriptor(
    name="TripUpdate",
    full_name="gtfs_realtime_transiter_vendorized.TripUpdate",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="trip",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.trip",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="vehicle",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.vehicle",
            index=1,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.stop_time_update",
            index=2,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.timestamp",
            index=3,
            number=4,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="delay",
            full_name="gtfs_realtime_transiter_vendorized.TripUpdate.delay",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
_VEHICLEPOSITION = _descriptor.Descriptor(
    ...
    full_name="gtfs_realtime_transiter_vendorized.VehiclePosition",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="trip",
            full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.trip",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="vehicle",
            full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.vehicle",
            index=1,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="position",
            full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.position",
            index=2,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.current_stop_sequence",
            index=3,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="stop_id",
            full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.stop_id",
            index=4,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="current_status",
            full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.current_status",
            index=5,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.timestamp",
            index=6,
            number=5,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.congestion_level",
            index=7,
            number=6,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.occupancy_status",
            index=8,
            number=9,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.VehiclePosition.occupancy_percentage",
            index=9,
            number=10,
            type=13,
            cpp_type=3,
...
_ALERT = _descriptor.Descriptor(
    name="Alert",
    full_name="gtfs_realtime_transiter_vendorized.Alert",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="active_period",
            full_name="gtfs_realtime_transiter_vendorized.Alert.active_period",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.Alert.informed_entity",
            index=1,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="url",
            full_name="gtfs_realtime_transiter_vendorized.Alert.url",
            index=4,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="header_text",
            full_name="gtfs_realtime_transiter_vendorized.Alert.header_text",
            index=5,
            number=10,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.Alert.description_text",
            index=6,
            number=11,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.Alert.tts_header_text",
            index=7,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="gtfs_realtime_transiter_vendorized.Alert.tts_description_text",
            index=8,
            number=13,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="severity_level",
            full_name="gtfs_realtime_transiter_vendorized.Alert.severity_level",
            index=9,
            number=14,
            type=14,
            cpp_type=8,
...
_TIMERANGE = _descriptor.Descriptor(
    name="TimeRange",
    full_name="gtfs_realtime_transiter_vendorized.TimeRange",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="start",
            full_name="gtfs_realtime_transiter_vendorized.TimeRange.start",
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="end",
            full_name="gtfs_realtime_transiter_vendorized.TimeRange.end",
            index=1,
            number=2,
            type=4,
            cpp_type=4,
...
_POSITION = _descriptor.Descriptor(
    name="Position",
    full_name="gtfs_realtime_transiter_vendorized.Position",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="latitude",
            full_name="gtfs_realtime_transiter_vendorized.Position.latitude",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="longitude",
            full_name="gtfs_realtime_transiter_vendorized.Position.longitude",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="bearing",
            full_name="gtfs_realtime_transiter_vendorized.Position.bearing",
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="odometer",
            full_name="gtfs_realtime_transiter_vendorized.Position.odometer",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="speed",
            full_name="gtfs_realtime_transiter_vendorized.Position.speed",
            index=4,
            number=5,
            type=2,
            cpp_type=6,
...
_TRIPDESCRIPTOR = _descriptor.Descriptor(
    name="TripDescriptor",
    full_name="gtfs_realtime_transiter_vendorized.TripDescriptor",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="trip_id",
            full_name="gtfs_realtime_transiter_vendorized.TripDescriptor.trip_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="route_id",
            full_name="gtfs_realtime_transiter_vendorized.TripDescriptor.route_id",
            index=1,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="direction_id",
            full_name="gtfs_realtime_transiter_vendorized.TripDescriptor.direction_id",
            index=2,
            number=6,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="start_time",
            full_name="gtfs_realtime_transiter_vendorized.TripDescriptor.start_time",
            index=3,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="start_date",
            full_name="gtfs_realtime_transiter_vendorized.TripDescriptor.start_date",
            index=4,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="schedule_relationship",
            full_name="gtfs_realtime_transiter_vendorized.TripDescriptor.schedule_relationship",
            index=5,
            number=4,
            type=14,
            cpp_type=8,
...
_VEHICLEDESCRIPTOR = _descriptor.Descriptor(
    ...
    full_name="gtfs_realtime_transiter_vendorized.VehicleDescriptor",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="gtfs_realtime_transiter_vendorized.VehicleDescriptor.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="label",
            full_name="gtfs_realtime_transiter_vendorized.VehicleDescriptor.label",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="license_plate",
            full_name="gtfs_realtime_transiter_vendorized.VehicleDescriptor.license_plate",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_ENTITYSELECTOR = _descriptor.Descriptor(
    name="EntitySelector",
    full_name="gtfs_realtime_transiter_vendorized.EntitySelector",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="agency_id",
            full_name="gtfs_realtime_transiter_vendorized.EntitySelector.agency_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="route_id",
            full_name="gtfs_realtime_transiter_vendorized.EntitySelector.route_id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="route_type",
            full_name="gtfs_realtime_transiter_vendorized.EntitySelector.route_type",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="trip",
            full_name="gtfs_realtime_transiter_vendorized.EntitySelector.trip",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="stop_id",
            full_name="gtfs_realtime_transiter_vendorized.EntitySelector.stop_id",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="direction_id",
            full_name="gtfs_realtime_transiter_vendorized.EntitySelector.direction_id",
            index=5,
            number=6,
            type=13,
            cpp_type=3,
...
_TRANSLATEDSTRING_TRANSLATION = _descriptor.Descriptor(
    name="Translation",
    full_name="gtfs_realtime_transiter_vendorized.TranslatedString.Translation",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="text",
            full_name="gtfs_realtime_transiter_vendorized.TranslatedString.Translation.text",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="language",
            full_name="gtfs_realtime_transiter_vendorized.TranslatedString.Translation.language",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_TRANSLATEDSTRING = _descriptor.Descriptor(
    ...
    full_name="gtfs_realtime_transiter_vendorized.TranslatedString",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
...
FeedMessage = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.FeedMessage)
    ),
)
...
FeedHeader = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.FeedHeader)
    ),
)
...
FeedEntity = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.FeedEntity)
    ),
)
    ...
    dict(
        StopTimeEvent=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="gtfs_realtime_transiter_vendorized_pb2"
                # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeEvent)
            ),
        ),
        StopTimeUpdate=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="gtfs_realtime_transiter_vendorized_pb2"
                # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.TripUpdate.StopTimeUpdate)
            ),
        ),
        DESCRIPTOR=_TRIPUPDATE,
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.TripUpdate)
    ),
)
...
VehiclePosition = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.VehiclePosition)
    ),
)
...
Alert = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        DESCRIPTOR=_ALERT,
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.Alert)
    ),
)
...
TimeRange = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.TimeRange)
    ),
)
...
Position = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.Position)
    ),
)
...
TripDescriptor = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.TripDescriptor)
    ),
)
...
VehicleDescriptor = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.VehicleDescriptor)
    ),
)
...
EntitySelector = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.EntitySelector)
    ),
)
    ...
    dict(
        Translation=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="gtfs_realtime_transiter_vendorized_pb2"
                # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.TranslatedString.Translation)
            ),
        ),
        DESCRIPTOR=_TRANSLATEDSTRING,
        __module__="gtfs_realtime_transiter_vendorized_pb2"
        # @@protoc_insertion_point(class_scope:gtfs_realtime_transiter_vendorized.TranslatedString)
    ),
)
