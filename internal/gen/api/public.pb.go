...
type EntrypointReply struct {
	...
	Systems []*System_Reference `protobuf:"bytes,2,rep,name=systems,proto3" json:"systems,omitempty"`
}
...
func (x *EntrypointReply) GetSystems() []*System_Reference {
	if x != nil {
		return x.Systems
	}
	return nil
...
type ListFeedsReply struct {
	...
	Feeds []*Feed_Reference `protobuf:"bytes,1,rep,name=feeds,proto3" json:"feeds,omitempty"`
}
...
func (x *ListFeedsReply) GetFeeds() []*Feed_Reference {
	if x != nil {
		return x.Feeds
	}
	return nil
...
type Stop struct {
	...
	System *System_Reference `protobuf:"bytes,2,opt,name=system,proto3" json:"system,omitempty"`
	...
	Type Stop_Type `protobuf:"varint,10,opt,name=type,proto3,enum=Stop_Type" json:"type,omitempty"`
	// Parent stop. This is determined using the `parent_station` column in `stops.txt`.
	ParentStop *Stop_Reference `protobuf:"bytes,11,opt,name=parent_stop,json=parentStop,proto3,oneof" json:"parent_stop,omitempty"`
	// Child stops. This are determined using the `parent_station` column in `stops.txt`.
	ChildStops []*Stop_Reference `protobuf:"bytes,12,rep,name=child_stops,json=childStops,proto3" json:"child_stops,omitempty"`
	...
	WheelchairBoarding *bool `protobuf:"varint,14,opt,name=wheelchair_boarding,json=wheelchairBoarding,proto3,oneof" json:"wheelchair_boarding,omitempty"`
	// Platform code of the stop. This is the `platform_code` column in `stops.txt`.
	PlatformCode *string `protobuf:"bytes,15,opt,name=platform_code,json=platformCode,proto3,oneof" json:"platform_code,omitempty"`
	// List of service maps for this stop.
	ServiceMaps []*Stop_ServiceMap `protobuf:"bytes,16,rep,name=service_maps,json=serviceMaps,proto3" json:"service_maps,omitempty"`
	...
	Alerts []*Alert_Reference `protobuf:"bytes,17,rep,name=alerts,proto3" json:"alerts,omitempty"`
	// List of realtime stop times for this stop.
	//
	// A stop time is an event at which a trip calls at a stop.
	StopTimes []*StopTime `protobuf:"bytes,18,rep,name=stop_times,json=stopTimes,proto3" json:"stop_times,omitempty"`
	// Transfers out of this stop.
	//
	// These are determined using the `from_stop_id` field in the GTFS static `transfers.txt` file.
	Transfers []*Transfer `protobuf:"bytes,19,rep,name=transfers,proto3" json:"transfers,omitempty"`
	// List of headsign rules for this stop.
	HeadsignRules []*Stop_HeadsignRule `protobuf:"bytes,20,rep,name=headsign_rules,json=headsignRules,proto3" json:"headsign_rules,omitempty"`
}
...
type Trip struct {
	...
	Route       *Route_Reference   `protobuf:"bytes,2,opt,name=route,proto3" json:"route,omitempty"`
...
type Route struct {
	...
	LongName *string `protobuf:"bytes,4,opt,name=long_name,json=longName,proto3,oneof" json:"long_name,omitempty"`
	...
	ContinuousPickup string `protobuf:"bytes,10,opt,name=continuous_pickup,json=continuousPickup,proto3" json:"continuous_pickup,omitempty"`
	// Continuous dropoff policy. This is the `continuous_dropoff` column in `routes.txt`.
	ContinuousDropOff string `protobuf:"bytes,11,opt,name=continuous_drop_off,json=continuousDropOff,proto3" json:"continuous_drop_off,omitempty"`
	...
	Agency *Agency_Reference `protobuf:"bytes,13,opt,name=agency,proto3" json:"agency,omitempty"`
	// Active alerts for this route.
	//
	// These are determined using the `informed_entity` field in
	// the [GTFS realtime alerts
	// message](https://developers.google.com/transit/gtfs-realtime/reference#message-alert).
	Alerts []*Alert_Reference `protobuf:"bytes,14,rep,name=alerts,proto3" json:"alerts,omitempty"`
	...
	// / all stops.
	EstimatedHeadway *int32 `protobuf:"varint,15,opt,name=estimated_headway,json=estimatedHeadway,proto3,oneof" json:"estimated_headway,omitempty"`
	// List of service maps for this route.
	ServiceMaps []*Route_ServiceMap `protobuf:"bytes,16,rep,name=service_maps,json=serviceMaps,proto3" json:"service_maps,omitempty"`
}
...
type Feed struct {
	...
	PeriodicUpdateEnabled bool `protobuf:"varint,3,opt,name=periodic_update_enabled,json=periodicUpdateEnabled,proto3" json:"periodic_update_enabled,omitempty"`
	// If periodic update is enabled, the period each update is triggered.
	PeriodicUpdatePeriod *string       `protobuf:"bytes,4,opt,name=periodic_update_period,json=periodicUpdatePeriod,proto3,oneof" json:"periodic_update_period,omitempty"`
	Updates              *Feed_Updates `protobuf:"bytes,5,opt,name=updates,proto3,oneof" json:"updates,omitempty"`
}
...
type Agency struct {
	...
	FareUrl *string `protobuf:"bytes,8,opt,name=fare_url,json=fareUrl,proto3,oneof" json:"fare_url,omitempty"`
	...
	Routes []*Route_Reference `protobuf:"bytes,10,rep,name=routes,proto3" json:"routes,omitempty"`
	// List of active alerts for the agency.
	//
	// These are determined using the `informed_entity` field in
	// the [GTFS realtime alerts
	// message](https://developers.google.com/transit/gtfs-realtime/reference#message-alert).
	Alerts []*Alert_Reference `protobuf:"bytes,11,rep,name=alerts,proto3" json:"alerts,omitempty"`
}
...
type Alert struct {
	...
	Cause Alert_Cause `protobuf:"varint,3,opt,name=cause,proto3,enum=Alert_Cause" json:"cause,omitempty"`
	// Effect of the alert. This corresponds to the `effect` field in the realtime alert message.
	Effect Alert_Effect `protobuf:"varint,4,opt,name=effect,proto3,enum=Alert_Effect" json:"effect,omitempty"`
	// The current active period, if the alert is currently active.
	// If the alert is not active this is empty.
	CurrentActivePeriod *Alert_ActivePeriod `protobuf:"bytes,5,opt,name=current_active_period,json=currentActivePeriod,proto3,oneof" json:"current_active_period,omitempty"`
	// All active periods for this alert.
	// Transiter guarantees that these active periods have no overlap.
	AllActivePeriods []*Alert_ActivePeriod `protobuf:"bytes,6,rep,name=all_active_periods,json=allActivePeriods,proto3" json:"all_active_periods,omitempty"`
	// Header of the alert, in zero or more languages.
	// This corresponds to the `header_text` field in the realtime alert message.
	Header []*Alert_Text `protobuf:"bytes,7,rep,name=header,proto3" json:"header,omitempty"`
	...
	Description []*Alert_Text `protobuf:"bytes,8,rep,name=description,proto3" json:"description,omitempty"`
	...
	Url []*Alert_Text `protobuf:"bytes,9,rep,name=url,proto3" json:"url,omitempty"`
}
...
type Transfer struct {
	...
	FromStop        *Stop_Reference `protobuf:"bytes,1,opt,name=from_stop,json=fromStop,proto3" json:"from_stop,omitempty"`
	ToStop          *Stop_Reference `protobuf:"bytes,2,opt,name=to_stop,json=toStop,proto3" json:"to_stop,omitempty"`
...
func (x *System_Reference) GetHref() string {
	if x != nil && x.Href != nil {
		return *x.Href
	}
	return ""
...
func (x *Stop_Reference) GetHref() string {
	if x != nil && x.Href != nil {
		return *x.Href
	}
	return ""
...
type Trip_Reference struct {
	...
	Id          string             `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Route       *Route_Reference   `protobuf:"bytes,2,opt,name=route,proto3" json:"route,omitempty"`
	Destination *Stop_Reference    `protobuf:"bytes,3,opt,name=destination,proto3" json:"destination,omitempty"`
	Vehicle     *Vehicle_Reference `protobuf:"bytes,4,opt,name=vehicle,proto3,oneof" json:"vehicle,omitempty"`
...
func (x *Trip_Reference) GetHref() string {
	if x != nil && x.Href != nil {
		return *x.Href
	}
	return ""
...
func (x *Route_Reference) GetHref() string {
	if x != nil && x.Href != nil {
		return *x.Href
	}
	return ""
...
func (*Feed_Reference) Descriptor() ([]byte, []int) {
	return file_api_public_proto_rawDescGZIP(), []int{33, 1}
}
...
func (x *Feed_Reference) GetHref() string {
	if x != nil && x.Href != nil {
		return *x.Href
	}
	return ""
...
func (x *Agency_Reference) GetHref() string {
	if x != nil && x.Href != nil {
		return *x.Href
	}
	return ""
...
func (x *Alert_Reference) GetHref() string {
	if x != nil && x.Href != nil {
		return *x.Href
	}
	return ""
...
var file_api_public_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xb7, 0x03, 0x0a, 0x0f, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x70,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x49, 0x64, 0x22, 0x32, 0x0a,
	...
	0x64, 0x22, 0x38, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x67, 0x65, 0x6e, 0x63, 0x69, 0x65,
	0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x23, 0x0a, 0x08, 0x61, 0x67, 0x65, 0x6e, 0x63, 0x69,
	0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x41, 0x67, 0x65, 0x6e, 0x63,
	0x79, 0x52, 0x08, 0x61, 0x67, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x22, 0x4c, 0x0a, 0x10, 0x47,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x49, 0x64, 0x12, 0x19,
	0x0a, 0x08, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x49, 0x64, 0x12, 0x36, 0x0a, 0x17, 0x73, 0x6b, 0x69,
	0x70, 0x5f, 0x65, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x68, 0x65, 0x61, 0x64,
	0x77, 0x61, 0x79, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x15, 0x73, 0x6b, 0x69, 0x70,
	...
	0x65, 0x5f, 0x6d, 0x61, 0x70, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x73, 0x6b,
	0x69, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4d, 0x61, 0x70, 0x73, 0x12, 0x1f, 0x0a,
	0x0b, 0x73, 0x6b, 0x69, 0x70, 0x5f, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x73, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x0a, 0x73, 0x6b, 0x69, 0x70, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x73, 0x22, 0x4a,
	0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x72, 0x69, 0x70, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x09, 0x52, 0x07, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x49, 0x64, 0x22, 0x2d, 0x0a, 0x0e, 0x4c, 0x69,
	0x73, 0x74, 0x54, 0x72, 0x69, 0x70, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1b, 0x0a, 0x05,
	0x74, 0x72, 0x69, 0x70, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x54, 0x72,
	0x69, 0x70, 0x52, 0x05, 0x74, 0x72, 0x69, 0x70, 0x73, 0x22, 0x4b, 0x0a, 0x11, 0x4c, 0x69, 0x73,
	...
	0x6c, 0x65, 0x72, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x61,
	0x6c, 0x65, 0x72, 0x74, 0x49, 0x64, 0x22, 0x31, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c,
	0x65, 0x72, 0x74, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1e, 0x0a, 0x06, 0x61, 0x6c, 0x65,
	0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x06, 0x2e, 0x41, 0x6c, 0x65, 0x72,
	0x74, 0x52, 0x06, 0x61, 0x6c, 0x65, 0x72, 0x74, 0x73, 0x22, 0x49, 0x0a, 0x0f, 0x47, 0x65, 0x74,
	0x41, 0x6c, 0x65, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09,
	...
	0x72, 0x74, 0x49, 0x64, 0x22, 0x61, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52,
	...
	,
	...
	,
	...
	0x6e, 0x88, 0x01, 0x01, 0x12, 0x1c, 0x0a, 0x07, 0x7a, 0x6f, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x48, 0x03, 0x52, 0x06, 0x7a, 0x6f, 0x6e, 0x65, 0x49, 0x64, 0x88,
	0x01, 0x01, 0x12, 0x1f, 0x0a, 0x08, 0x6c, 0x61, 0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x18, 0x07,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x48, 0x02, 0x52, 0x07, 0x76, 0x65, 0x68, 0x69, 0x63, 0x6c, 0x65, 0x88, 0x01, 0x01, 0x12, 0x21,
	...
	0x64, 0x12, 0x28, 0x0a, 0x0a, 0x73, 0x74, 0x6f, 0x70, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x18,
	0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x53, 0x74, 0x6f, 0x70, 0x54, 0x69, 0x6d, 0x65,
	0x52, 0x09, 0x73, 0x74, 0x6f, 0x70, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x1a, 0xd7, 0x01, 0x0a, 0x09,
	0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x26, 0x0a, 0x05, 0x72, 0x6f, 0x75,
	0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x53, 0x74, 0x6f, 0x70, 0x2e, 0x52, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0xfc, 0x03, 0x0a, 0x06, 0x41, 0x67, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x29, 0x0a, 0x06, 0x73,
	0x79, 0x73, 0x74, 0x65, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x53, 0x79,
	0x73, 0x74, 0x65, 0x6d, 0x2e, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x06,
	0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03,
	...
	,
	...
	0x67, 0x75, 0x61, 0x67, 0x65, 0x1a, 0xb3, 0x01, 0x0a, 0x09, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65,
	0x6e, 0x63, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x02, 0x69, 0x64, 0x12, 0x29, 0x0a, 0x06, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x18, 0x02, 0x20,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x12, 0x1b, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x00, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x88, 0x01, 0x01, 0x12, 0x24,
	0x0a, 0x0b, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x65, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x48, 0x01, 0x52, 0x0a, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x54, 0x72, 0x61, 0x63,
	0x65, 0x88, 0x01, 0x01, 0x12, 0x2a, 0x0a, 0x0e, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x5f,
	0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x48, 0x02, 0x52, 0x0d,
	...
	,
	...
	0x6f, 0x70, 0x73, 0x2f, 0x7b, 0x73, 0x74, 0x6f, 0x70, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x57, 0x0a,
	0x0a, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x12, 0x12, 0x2e, 0x4c, 0x69,
	0x73, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x10, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6c,
	...
	0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x12, 0x54, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x75,
	0x74, 0x65, 0x12, 0x10, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x06, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x22, 0x2e, 0x82, 0xd3,
	...
	0x73, 0x2f, 0x7b, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x65, 0x0a, 0x09,
	0x4c, 0x69, 0x73, 0x74, 0x54, 0x72, 0x69, 0x70, 0x73, 0x12, 0x11, 0x2e, 0x4c, 0x69, 0x73, 0x74,
	0x54, 0x72, 0x69, 0x70, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x4c,
	0x69, 0x73, 0x74, 0x54, 0x72, 0x69, 0x70, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x34, 0x82,
	0xd3, 0xe4, 0x93, 0x02, 0x2e, 0x12, 0x2c, 0x2f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x73, 0x2f,
	...
	0x69, 0x70, 0x73, 0x12, 0x61, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x12, 0x0f,
	0x2e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x05, 0x2e, 0x54, 0x72, 0x69, 0x70, 0x22, 0x3e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x38, 0x12, 0x36,
	...
	,
	...
	0x7d, 0x2f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69, 0x74,
...
var file_api_public_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_api_public_proto_goTypes = []interface{}{
	...
	(Alert_Cause)(0),                               // 2: Alert.Cause
	(Alert_Effect)(0),                              // 3: Alert.Effect
	(Transfer_Type)(0),                             // 4: Transfer.Type
	(*EntrypointRequest)(nil),                      // 5: EntrypointRequest
	(*EntrypointReply)(nil),                        // 6: EntrypointReply
	(*ListSystemsRequest)(nil),                     // 7: ListSystemsRequest
	(*ListSystemsReply)(nil),                       // 8: ListSystemsReply
	(*GetSystemRequest)(nil),                       // 9: GetSystemRequest
	(*ListAgenciesRequest)(nil),                    // 10: ListAgenciesRequest
	(*ListAgenciesReply)(nil),                      // 11: ListAgenciesReply
	(*GetAgencyRequest)(nil),                       // 12: GetAgencyRequest
	(*ListStopsRequest)(nil),                       // 13: ListStopsRequest
	(*ListStopsReply)(nil),                         // 14: ListStopsReply
	(*GetStopRequest)(nil),                         // 15: GetStopRequest
	(*ListRoutesRequest)(nil),                      // 16: ListRoutesRequest
	(*ListRoutesReply)(nil),                        // 17: ListRoutesReply
	(*GetRouteRequest)(nil),                        // 18: GetRouteRequest
	(*ListTripsRequest)(nil),                       // 19: ListTripsRequest
	(*ListTripsReply)(nil),                         // 20: ListTripsReply
	(*ListAlertsRequest)(nil),                      // 21: ListAlertsRequest
	(*ListAlertsReply)(nil),                        // 22: ListAlertsReply
	(*GetAlertRequest)(nil),                        // 23: GetAlertRequest
	(*GetTripRequest)(nil),                         // 24: GetTripRequest
	(*ListFeedsRequest)(nil),                       // 25: ListFeedsRequest
	(*ListFeedsReply)(nil),                         // 26: ListFeedsReply
	(*ListFeedUpdatesRequest)(nil),                 // 27: ListFeedUpdatesRequest
	(*ListFeedUpdatesReply)(nil),                   // 28: ListFeedUpdatesReply
	(*GetFeedRequest)(nil),                         // 29: GetFeedRequest
	(*ListTransfersRequest)(nil),                   // 30: ListTransfersRequest
	(*ListTransfersReply)(nil),                     // 31: ListTransfersReply
	(*System)(nil),                                 // 32: System
	(*Stop)(nil),                                   // 33: Stop
	(*StopTime)(nil),                               // 34: StopTime
	(*Trip)(nil),                                   // 35: Trip
	(*Vehicle)(nil),                                // 36: Vehicle
	(*Route)(nil),                                  // 37: Route
	(*Feed)(nil),                                   // 38: Feed
	(*Agency)(nil),                                 // 39: Agency
	(*Alert)(nil),                                  // 40: Alert
	(*Transfer)(nil),                               // 41: Transfer
	(*FeedUpdate)(nil),                             // 42: FeedUpdate
	(*EntrypointReply_TransiterDetails)(nil),       // 43: EntrypointReply.TransiterDetails
	(*EntrypointReply_TransiterDetails_Build)(nil), // 44: EntrypointReply.TransiterDetails.Build
	(*System_ChildEntities)(nil),                   // 45: System.ChildEntities
	(*System_Reference)(nil),                       // 46: System.Reference
	(*Stop_ServiceMap)(nil),                        // 47: Stop.ServiceMap
	(*Stop_HeadsignRule)(nil),                      // 48: Stop.HeadsignRule
	(*Stop_Reference)(nil),                         // 49: Stop.Reference
	(*StopTime_EstimatedTime)(nil),                 // 50: StopTime.EstimatedTime
	(*Trip_Reference)(nil),                         // 51: Trip.Reference
	(*Vehicle_Reference)(nil),                      // 52: Vehicle.Reference
	(*Route_ServiceMap)(nil),                       // 53: Route.ServiceMap
	(*Route_Reference)(nil),                        // 54: Route.Reference
	(*Feed_Updates)(nil),                           // 55: Feed.Updates
	(*Feed_Reference)(nil),                         // 56: Feed.Reference
	(*Agency_Reference)(nil),                       // 57: Agency.Reference
	(*Alert_ActivePeriod)(nil),                     // 58: Alert.ActivePeriod
	(*Alert_Text)(nil),                             // 59: Alert.Text
	(*Alert_Reference)(nil),                        // 60: Alert.Reference
}
var file_api_public_proto_depIdxs = []int32{
	43, // 0: EntrypointReply.transiter:type_name -> EntrypointReply.TransiterDetails
	46, // 1: EntrypointReply.systems:type_name -> System.Reference
	32, // 2: ListSystemsReply.systems:type_name -> System
	39, // 3: ListAgenciesReply.agencies:type_name -> Agency
	33, // 4: ListStopsReply.stops:type_name -> Stop
	37, // 5: ListRoutesReply.routes:type_name -> Route
	35, // 6: ListTripsReply.trips:type_name -> Trip
	40, // 7: ListAlertsReply.alerts:type_name -> Alert
	56, // 8: ListFeedsReply.feeds:type_name -> Feed.Reference
	42, // 9: ListFeedUpdatesReply.updates:type_name -> FeedUpdate
	41, // 10: ListTransfersReply.transfers:type_name -> Transfer
	0,  // 11: System.status:type_name -> System.Status
	45, // 12: System.agencies:type_name -> System.ChildEntities
	45, // 13: System.feeds:type_name -> System.ChildEntities
	45, // 14: System.routes:type_name -> System.ChildEntities
	45, // 15: System.stops:type_name -> System.ChildEntities
	45, // 16: System.transfers:type_name -> System.ChildEntities
	46, // 17: Stop.system:type_name -> System.Reference
	1,  // 18: Stop.type:type_name -> Stop.Type
	49, // 19: Stop.parent_stop:type_name -> Stop.Reference
	49, // 20: Stop.child_stops:type_name -> Stop.Reference
	47, // 21: Stop.service_maps:type_name -> Stop.ServiceMap
	60, // 22: Stop.alerts:type_name -> Alert.Reference
	34, // 23: Stop.stop_times:type_name -> StopTime
	41, // 24: Stop.transfers:type_name -> Transfer
	48, // 25: Stop.headsign_rules:type_name -> Stop.HeadsignRule
	49, // 26: StopTime.stop:type_name -> Stop.Reference
	51, // 27: StopTime.trip:type_name -> Trip.Reference
	50, // 28: StopTime.arrival:type_name -> StopTime.EstimatedTime
	50, // 29: StopTime.departure:type_name -> StopTime.EstimatedTime
	54, // 30: Trip.route:type_name -> Route.Reference
	52, // 31: Trip.vehicle:type_name -> Vehicle.Reference
	34, // 32: Trip.stop_times:type_name -> StopTime
	46, // 33: Route.system:type_name -> System.Reference
	57, // 34: Route.agency:type_name -> Agency.Reference
	60, // 35: Route.alerts:type_name -> Alert.Reference
	53, // 36: Route.service_maps:type_name -> Route.ServiceMap
	46, // 37: Feed.system:type_name -> System.Reference
	55, // 38: Feed.updates:type_name -> Feed.Updates
	46, // 39: Agency.system:type_name -> System.Reference
	54, // 40: Agency.routes:type_name -> Route.Reference
	60, // 41: Agency.alerts:type_name -> Alert.Reference
	46, // 42: Alert.system:type_name -> System.Reference
	2,  // 43: Alert.cause:type_name -> Alert.Cause
	3,  // 44: Alert.effect:type_name -> Alert.Effect
	58, // 45: Alert.current_active_period:type_name -> Alert.ActivePeriod
	58, // 46: Alert.all_active_periods:type_name -> Alert.ActivePeriod
	59, // 47: Alert.header:type_name -> Alert.Text
	59, // 48: Alert.description:type_name -> Alert.Text
	59, // 49: Alert.url:type_name -> Alert.Text
	49, // 50: Transfer.from_stop:type_name -> Stop.Reference
	49, // 51: Transfer.to_stop:type_name -> Stop.Reference
	4,  // 52: Transfer.type:type_name -> Transfer.Type
	44, // 53: EntrypointReply.TransiterDetails.build:type_name -> EntrypointReply.TransiterDetails.Build
	54, // 54: Stop.ServiceMap.routes:type_name -> Route.Reference
	49, // 55: Stop.HeadsignRule.stop:type_name -> Stop.Reference
	46, // 56: Stop.Reference.system:type_name -> System.Reference
	54, // 57: Trip.Reference.route:type_name -> Route.Reference
	49, // 58: Trip.Reference.destination:type_name -> Stop.Reference
	52, // 59: Trip.Reference.vehicle:type_name -> Vehicle.Reference
	49, // 60: Route.ServiceMap.stops:type_name -> Stop.Reference
	46, // 61: Route.Reference.system:type_name -> System.Reference
	46, // 62: Feed.Reference.system:type_name -> System.Reference
	46, // 63: Agency.Reference.system:type_name -> System.Reference
	46, // 64: Alert.Reference.system:type_name -> System.Reference
	2,  // 65: Alert.Reference.cause:type_name -> Alert.Cause
	3,  // 66: Alert.Reference.effect:type_name -> Alert.Effect
	5,  // 67: Public.Entrypoint:input_type -> EntrypointRequest
	7,  // 68: Public.ListSystems:input_type -> ListSystemsRequest
	9,  // 69: Public.GetSystem:input_type -> GetSystemRequest
	10, // 70: Public.ListAgencies:input_type -> ListAgenciesRequest
	12, // 71: Public.GetAgency:input_type -> GetAgencyRequest
	13, // 72: Public.ListStops:input_type -> ListStopsRequest
	15, // 73: Public.GetStop:input_type -> GetStopRequest
	16, // 74: Public.ListRoutes:input_type -> ListRoutesRequest
	18, // 75: Public.GetRoute:input_type -> GetRouteRequest
	19, // 76: Public.ListTrips:input_type -> ListTripsRequest
	24, // 77: Public.GetTrip:input_type -> GetTripRequest
	21, // 78: Public.ListAlerts:input_type -> ListAlertsRequest
	23, // 79: Public.GetAlert:input_type -> GetAlertRequest
	30, // 80: Public.ListTransfers:input_type -> ListTransfersRequest
	25, // 81: Public.ListFeeds:input_type -> ListFeedsRequest
	29, // 82: Public.GetFeed:input_type -> GetFeedRequest
	27, // 83: Public.ListFeedUpdates:input_type -> ListFeedUpdatesRequest
	6,  // 84: Public.Entrypoint:output_type -> EntrypointReply
	8,  // 85: Public.ListSystems:output_type -> ListSystemsReply
	32, // 86: Public.GetSystem:output_type -> System
	11, // 87: Public.ListAgencies:output_type -> ListAgenciesReply
	39, // 88: Public.GetAgency:output_type -> Agency
	14, // 89: Public.ListStops:output_type -> ListStopsReply
	33, // 90: Public.GetStop:output_type -> Stop
	17, // 91: Public.ListRoutes:output_type -> ListRoutesReply
	37, // 92: Public.GetRoute:output_type -> Route
	20, // 93: Public.ListTrips:output_type -> ListTripsReply
	35, // 94: Public.GetTrip:output_type -> Trip
	22, // 95: Public.ListAlerts:output_type -> ListAlertsReply
	40, // 96: Public.GetAlert:output_type -> Alert
	31, // 97: Public.ListTransfers:output_type -> ListTransfersReply
	26, // 98: Public.ListFeeds:output_type -> ListFeedsReply
	38, // 99: Public.GetFeed:output_type -> Feed
	28, // 100: Public.ListFeedUpdates:output_type -> ListFeedUpdatesReply
