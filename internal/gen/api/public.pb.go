...
func (ListVehiclesRequest_SearchMode) EnumDescriptor() ([]byte, []int) {
	return file_api_public_proto_rawDescGZIP(), []int{26, 0}
}
...
func (Vehicle_OccupancyStatus) EnumDescriptor() ([]byte, []int) {
	return file_api_public_proto_rawDescGZIP(), []int{38, 2}
}
...
func (Route_Type) EnumDescriptor() ([]byte, []int) {
	return file_api_public_proto_rawDescGZIP(), []int{39, 1}
}
...
func (Alert_Effect) EnumDescriptor() ([]byte, []int) {
	return file_api_public_proto_rawDescGZIP(), []int{42, 1}
}
...
const (
	...
	Transfer_NOT_POSSIBLE  Transfer_Type = 3
)
...
type ListStopsRequest struct {
	...
	//
	// Deprecated: Marked as deprecated in api/public.proto.
	...
	FilterById bool `protobuf:"varint,15,opt,name=filter_by_id,json=filterById,proto3" json:"filter_by_id,omitempty"`
	...
	FilterByType bool `protobuf:"varint,16,opt,name=filter_by_type,json=filterByType,proto3" json:"filter_by_type,omitempty"`
	// Types to filter by if `filter_by_type` is set to true.
	// It is an error to populate this field if `filter_by_id` is false.
	Type []Stop_Type `protobuf:"varint,17,rep,packed,name=type,proto3,enum=Stop_Type" json:"type,omitempty"`
...
func (x *ListStopsRequest) GetFilterById() bool {
	if x != nil {
		return x.FilterById
	}
	return false
...
func (x *ListStopsRequest) GetFilterByType() bool {
	if x != nil {
...
func (x *ListStopsRequest) GetType() []Stop_Type {
	if x != nil {
		return x.Type
	}
	return nil
...
func (x *GetTransferRequest) GetSystemId() string {
	if x != nil {
		return x.SystemId
	}
	return ""
...
type ListVehiclesRequest struct {
	...
	// Only supported when the search mode is ID.
	FilterById bool `protobuf:"varint,10,opt,name=filter_by_id,json=filterById,proto3" json:"filter_by_id,omitempty"`
...
func (x *ListVehiclesRequest) GetFilterById() bool {
	if x != nil {
		return x.FilterById
	}
	return false
...
type ListShapesRequest struct {
	...
	FilterById bool `protobuf:"varint,6,opt,name=filter_by_id,json=filterById,proto3" json:"filter_by_id,omitempty"`
	// IDs to return if `filter_by_id` is set to true. It is an error to
	// populate this field if `filter_by_id` is false.
...
func (x *ListShapesRequest) GetFilterById() bool {
	if x != nil {
		return x.FilterById
	}
	return false
...
func (x *ChildResources) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *ChildResources) GetUrl() string {
	if x != nil && x.Url != nil {
		return *x.Url
	}
	return ""
...
type Feed struct {
	...
	// This is the parent resource in Transiter's resource hierarchy.
	System *System_Reference `protobuf:"bytes,3,opt,name=system,proto3" json:"system,omitempty"`
	// Number of milliseconds since the last update of this feed finished.
	...
	// Number of milliseconds since the last successful update of this feed finished.
	...
	// Number of milliseconds since the last skipped update of this feed finished.
	...
	// Number of milliseconds since the last failed update of this feed finished.
...
type Transfer struct {
	...
	// This is the parent resource in Transiter's resource hierarchy.
	System *System_Reference `protobuf:"bytes,11,opt,name=system,proto3" json:"system,omitempty"`
...
func (x *Transfer) GetResource() *Resource {
	if x != nil {
		return x.Resource
	}
	return nil
...
func (x *Transfer) GetSystem() *System_Reference {
	if x != nil {
		return x.System
	}
	return nil
...
func (x *EntrypointReply_TransiterDetails) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *EntrypointReply_TransiterDetails_Build) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (*Stop_HeadsignRule) Descriptor() ([]byte, []int) {
	return file_api_public_proto_rawDescGZIP(), []int{35, 1}
}
...
func (*Stop_Reference) Descriptor() ([]byte, []int) {
	return file_api_public_proto_rawDescGZIP(), []int{35, 2}
}
...
func (*Alert_Reference) Descriptor() ([]byte, []int) {
	return file_api_public_proto_rawDescGZIP(), []int{42, 2}
}
...
func (*Shape_ShapePoint) Descriptor() ([]byte, []int) {
	return file_api_public_proto_rawDescGZIP(), []int{44, 0}
}
...
func (x *Shape_Reference) Reset() {
	*x = Shape_Reference{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_public_proto_msgTypes[62]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Shape_Reference) Descriptor() ([]byte, []int) {
	return file_api_public_proto_rawDescGZIP(), []int{44, 1}
}
...
var file_api_public_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xbd, 0x03, 0x0a, 0x0f, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x70,
	...
	0x73, 0x74, 0x65, 0x6d, 0x73, 0x1a, 0xbd, 0x02, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x69,
	...
	0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x42, 0x0a, 0x05, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x18,
	...
	0x52, 0x05, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x88, 0x01, 0x01, 0x1a, 0xa8, 0x01, 0x0a, 0x05, 0x42,
	...
	,
	...
	,
	...
	0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x61, 0x67, 0x65, 0x6e, 0x63, 0x79, 0x5f, 0x69, 0x64, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x67, 0x65, 0x6e, 0x63, 0x79, 0x49, 0x64, 0x22,
	0xe4, 0x05, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x74, 0x6f, 0x70, 0x73, 0x52, 0x65, 0x71,
	...
	,
	...
	0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x22, 0x57, 0x0a, 0x0e, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x74,
	0x6f, 0x70, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1b, 0x0a, 0x05, 0x73, 0x74, 0x6f, 0x70,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x53, 0x74, 0x6f, 0x70, 0x52, 0x05,
	0x73, 0x74, 0x6f, 0x70, 0x73, 0x12, 0x1c, 0x0a, 0x07, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x69, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x06, 0x6e, 0x65, 0x78, 0x74, 0x49, 0x64,
	0x88, 0x01, 0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x69, 0x64, 0x22,
	0xe2, 0x01, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x53, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	0xce, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	,
	...
	0x52, 0x08, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x49, 0x64, 0x22, 0x2d, 0x0a, 0x0e, 0x4c, 0x69,
	0x73, 0x74, 0x46, 0x65, 0x65, 0x64, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1b, 0x0a, 0x05,
	0x66, 0x65, 0x65, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x05, 0x2e, 0x46, 0x65,
	0x65, 0x64, 0x52, 0x05, 0x66, 0x65, 0x65, 0x64, 0x73, 0x22, 0x46, 0x0a, 0x0e, 0x47, 0x65, 0x74,
	0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x73,
	...
	0x64, 0x22, 0x33, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	...
	0x73, 0x74, 0x65, 0x6d, 0x49, 0x64, 0x22, 0x3d, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x27, 0x0a, 0x09,
	...
	0x73, 0x66, 0x65, 0x72, 0x73, 0x22, 0x52, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x66, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x73,
	0x79, 0x73, 0x74, 0x65, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x72, 0x61, 0x6e,
	0x73, 0x66, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x74,
	0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x49, 0x64, 0x22, 0x88, 0x04, 0x0a, 0x13, 0x4c, 0x69,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x63, 0x65, 0x52, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x74, 0x0a,
	0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f,
	0x57, 0x4e, 0x10, 0x00, 0x12, 0x0e, 0x0a, 0x0a, 0x49, 0x4e, 0x53, 0x54, 0x41, 0x4c, 0x4c, 0x49,
	0x4e, 0x47, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x41, 0x43, 0x54, 0x49, 0x56, 0x45, 0x10, 0x02,
	0x12, 0x12, 0x0a, 0x0e, 0x49, 0x4e, 0x53, 0x54, 0x41, 0x4c, 0x4c, 0x5f, 0x46, 0x41, 0x49, 0x4c,
	0x45, 0x44, 0x10, 0x03, 0x12, 0x0c, 0x0a, 0x08, 0x55, 0x50, 0x44, 0x41, 0x54, 0x49, 0x4e, 0x47,
	...
	0x47, 0x10, 0x06, 0x22, 0x43, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12,
	0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70,
	0x61, 0x74, 0x68, 0x12, 0x15, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x48, 0x00, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x88, 0x01, 0x01, 0x42, 0x06, 0x0a, 0x04, 0x5f, 0x75,
	0x72, 0x6c, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0x5f, 0x0a, 0x0e, 0x43, 0x68, 0x69, 0x6c,
	0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f,
	...
	0x70, 0x61, 0x74, 0x68, 0x12, 0x15, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x00, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x88, 0x01, 0x01, 0x42, 0x06, 0x0a, 0x04, 0x5f,
	0x75, 0x72, 0x6c, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0xab, 0x0b, 0x0a, 0x04, 0x53, 0x74,
	...
	0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x29, 0x0a, 0x06, 0x73, 0x79, 0x73,
	0x74, 0x65, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x53, 0x79, 0x73, 0x74,
	0x65, 0x6d, 0x2e, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x06, 0x73, 0x79,
	0x73, 0x74, 0x65, 0x6d, 0x12, 0x17, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x09, 0x48, 0x00, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x88, 0x01, 0x01, 0x12, 0x17, 0x0a,
	...
	0x07, 0x7a, 0x6f, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x48, 0x03,
	0x52, 0x06, 0x7a, 0x6f, 0x6e, 0x65, 0x49, 0x64, 0x88, 0x01, 0x01, 0x12, 0x1f, 0x0a, 0x08, 0x6c,
	...
	,
	...
	0x0a, 0x06, 0x5f, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x22, 0xdd, 0x04, 0x0a, 0x04, 0x54, 0x72, 0x69,
	...
	0x69, 0x6d, 0x65, 0x73, 0x12, 0x2b, 0x0a, 0x05, 0x73, 0x68, 0x61, 0x70, 0x65, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x53, 0x68, 0x61, 0x70, 0x65, 0x2e, 0x52, 0x65, 0x66, 0x65,
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x48, 0x02, 0x52, 0x05, 0x73, 0x68, 0x61, 0x70, 0x65, 0x88, 0x01,
	0x01, 0x1a, 0xff, 0x01, 0x0a, 0x09, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x26, 0x0a, 0x05, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x52, 0x65,
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x05, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x31,
	...
	,
	...
	,
	...
	0x52, 0x06, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x22, 0x0a, 0x0a, 0x73, 0x68, 0x6f, 0x72,
	...
	0x6c, 0x6f, 0x6e, 0x67, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x48,
	0x01, 0x52, 0x08, 0x6c, 0x6f, 0x6e, 0x67, 0x4e, 0x61, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x14,
	0x0a, 0x05, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x63,
	0x6f, 0x6c, 0x6f, 0x72, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x65, 0x78, 0x74, 0x5f, 0x63, 0x6f, 0x6c,
	0x6f, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x65, 0x78, 0x74, 0x43, 0x6f,
	0x6c, 0x6f, 0x72, 0x12, 0x25, 0x0a, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	...
	,
	...
	0x05, 0x73, 0x74, 0x6f, 0x70, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x53,
	0x74, 0x6f, 0x70, 0x2e, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x05, 0x73,
	0x74, 0x6f, 0x70, 0x73, 0x1a, 0x83, 0x01, 0x0a, 0x09, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x06, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x12, 0x0a,
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	0x75, 0x72, 0x6c, 0x12, 0x1a, 0x0a, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x7a, 0x6f, 0x6e, 0x65, 0x18,
	...
	,
	...
	0x72, 0x6c, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0xea, 0x09, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x5f, 0x69, 0x64, 0x7d, 0x2f, 0x74, 0x72, 0x69, 0x70, 0x73, 0x12, 0x61, 0x0a, 0x07,
	0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x12, 0x0f, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69,
	0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x05, 0x2e, 0x54, 0x72, 0x69, 0x70, 0x22,
	0x3e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x38, 0x12, 0x36, 0x2f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d,
	...
	0x57, 0x0a, 0x0a, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x73, 0x12, 0x12, 0x2e,
	0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x10, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x73, 0x52, 0x65,
	...
	,
}
...
var file_api_public_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_api_public_proto_goTypes = []interface{}{
	...
	(*GetTransferRequest)(nil),                     // 37: GetTransferRequest
	(*ListVehiclesRequest)(nil),                    // 38: ListVehiclesRequest
	(*ListVehiclesReply)(nil),                      // 39: ListVehiclesReply
	(*GetVehicleRequest)(nil),                      // 40: GetVehicleRequest
	(*ListShapesRequest)(nil),                      // 41: ListShapesRequest
	(*ListShapesReply)(nil),                        // 42: ListShapesReply
	(*GetShapeRequest)(nil),                        // 43: GetShapeRequest
	(*System)(nil),                                 // 44: System
	(*Resource)(nil),                               // 45: Resource
	(*ChildResources)(nil),                         // 46: ChildResources
	(*Stop)(nil),                                   // 47: Stop
	(*StopTime)(nil),                               // 48: StopTime
	(*Trip)(nil),                                   // 49: Trip
	(*Vehicle)(nil),                                // 50: Vehicle
	(*Route)(nil),                                  // 51: Route
	(*Feed)(nil),                                   // 52: Feed
	(*Agency)(nil),                                 // 53: Agency
	(*Alert)(nil),                                  // 54: Alert
	(*Transfer)(nil),                               // 55: Transfer
	(*Shape)(nil),                                  // 56: Shape
	(*EntrypointReply_TransiterDetails)(nil),       // 57: EntrypointReply.TransiterDetails
	(*EntrypointReply_TransiterDetails_Build)(nil), // 58: EntrypointReply.TransiterDetails.Build
	(*System_Reference)(nil),                       // 59: System.Reference
	(*Stop_ServiceMap)(nil),                        // 60: Stop.ServiceMap
	(*Stop_HeadsignRule)(nil),                      // 61: Stop.HeadsignRule
	(*Stop_Reference)(nil),                         // 62: Stop.Reference
	(*StopTime_EstimatedTime)(nil),                 // 63: StopTime.EstimatedTime
	(*Trip_Reference)(nil),                         // 64: Trip.Reference
	(*Vehicle_Reference)(nil),                      // 65: Vehicle.Reference
	(*Route_ServiceMap)(nil),                       // 66: Route.ServiceMap
	(*Route_Reference)(nil),                        // 67: Route.Reference
	(*Feed_Reference)(nil),                         // 68: Feed.Reference
	(*Agency_Reference)(nil),                       // 69: Agency.Reference
	(*Alert_ActivePeriod)(nil),                     // 70: Alert.ActivePeriod
	(*Alert_Text)(nil),                             // 71: Alert.Text
	(*Alert_Reference)(nil),                        // 72: Alert.Reference
	(*Shape_ShapePoint)(nil),                       // 73: Shape.ShapePoint
	(*Shape_Reference)(nil),                        // 74: Shape.Reference
}
var file_api_public_proto_depIdxs = []int32{
	57,  // 0: EntrypointReply.transiter:type_name -> EntrypointReply.TransiterDetails
	46,  // 1: EntrypointReply.systems:type_name -> ChildResources
	44,  // 2: ListSystemsReply.systems:type_name -> System
	53,  // 3: ListAgenciesReply.agencies:type_name -> Agency
	0,   // 4: ListStopsRequest.search_mode:type_name -> ListStopsRequest.SearchMode
	3,   // 5: ListStopsRequest.type:type_name -> Stop.Type
	47,  // 6: ListStopsReply.stops:type_name -> Stop
	51,  // 7: ListRoutesReply.routes:type_name -> Route
	49,  // 8: ListTripsReply.trips:type_name -> Trip
	54,  // 9: ListAlertsReply.alerts:type_name -> Alert
	52,  // 10: ListFeedsReply.feeds:type_name -> Feed
	55,  // 11: ListTransfersReply.transfers:type_name -> Transfer
	1,   // 12: ListVehiclesRequest.search_mode:type_name -> ListVehiclesRequest.SearchMode
	50,  // 13: ListVehiclesReply.vehicles:type_name -> Vehicle
	56,  // 14: ListShapesReply.shapes:type_name -> Shape
	45,  // 15: System.resource:type_name -> Resource
	2,   // 16: System.status:type_name -> System.Status
	46,  // 17: System.agencies:type_name -> ChildResources
	46,  // 18: System.feeds:type_name -> ChildResources
	46,  // 19: System.routes:type_name -> ChildResources
	46,  // 20: System.stops:type_name -> ChildResources
	46,  // 21: System.transfers:type_name -> ChildResources
	45,  // 22: Stop.resource:type_name -> Resource
	59,  // 23: Stop.system:type_name -> System.Reference
	3,   // 24: Stop.type:type_name -> Stop.Type
	62,  // 25: Stop.parent_stop:type_name -> Stop.Reference
	62,  // 26: Stop.child_stops:type_name -> Stop.Reference
	60,  // 27: Stop.service_maps:type_name -> Stop.ServiceMap
	72,  // 28: Stop.alerts:type_name -> Alert.Reference
	48,  // 29: Stop.stop_times:type_name -> StopTime
	55,  // 30: Stop.transfers:type_name -> Transfer
	61,  // 31: Stop.headsign_rules:type_name -> Stop.HeadsignRule
	62,  // 32: StopTime.stop:type_name -> Stop.Reference
	64,  // 33: StopTime.trip:type_name -> Trip.Reference
	63,  // 34: StopTime.arrival:type_name -> StopTime.EstimatedTime
	63,  // 35: StopTime.departure:type_name -> StopTime.EstimatedTime
	45,  // 36: Trip.resource:type_name -> Resource
	67,  // 37: Trip.route:type_name -> Route.Reference
	65,  // 38: Trip.vehicle:type_name -> Vehicle.Reference
	48,  // 39: Trip.stop_times:type_name -> StopTime
	74,  // 40: Trip.shape:type_name -> Shape.Reference
	64,  // 41: Vehicle.trip:type_name -> Trip.Reference
	62,  // 42: Vehicle.stop:type_name -> Stop.Reference
	4,   // 43: Vehicle.current_status:type_name -> Vehicle.CurrentStatus
	5,   // 44: Vehicle.congestion_level:type_name -> Vehicle.CongestionLevel
	6,   // 45: Vehicle.occupancy_status:type_name -> Vehicle.OccupancyStatus
	45,  // 46: Route.resource:type_name -> Resource
	59,  // 47: Route.system:type_name -> System.Reference
	7,   // 48: Route.continuous_pickup:type_name -> Route.ContinuousPolicy
	7,   // 49: Route.continuous_drop_off:type_name -> Route.ContinuousPolicy
	8,   // 50: Route.type:type_name -> Route.Type
	69,  // 51: Route.agency:type_name -> Agency.Reference
	72,  // 52: Route.alerts:type_name -> Alert.Reference
	66,  // 53: Route.service_maps:type_name -> Route.ServiceMap
	45,  // 54: Feed.resource:type_name -> Resource
	59,  // 55: Feed.system:type_name -> System.Reference
	45,  // 56: Agency.resource:type_name -> Resource
	59,  // 57: Agency.system:type_name -> System.Reference
	67,  // 58: Agency.routes:type_name -> Route.Reference
	72,  // 59: Agency.alerts:type_name -> Alert.Reference
	45,  // 60: Alert.resource:type_name -> Resource
	59,  // 61: Alert.system:type_name -> System.Reference
	9,   // 62: Alert.cause:type_name -> Alert.Cause
	10,  // 63: Alert.effect:type_name -> Alert.Effect
	70,  // 64: Alert.current_active_period:type_name -> Alert.ActivePeriod
	70,  // 65: Alert.all_active_periods:type_name -> Alert.ActivePeriod
	71,  // 66: Alert.header:type_name -> Alert.Text
	71,  // 67: Alert.description:type_name -> Alert.Text
	71,  // 68: Alert.url:type_name -> Alert.Text
	45,  // 69: Transfer.resource:type_name -> Resource
	59,  // 70: Transfer.system:type_name -> System.Reference
	62,  // 71: Transfer.from_stop:type_name -> Stop.Reference
	62,  // 72: Transfer.to_stop:type_name -> Stop.Reference
	11,  // 73: Transfer.type:type_name -> Transfer.Type
	73,  // 74: Shape.points:type_name -> Shape.ShapePoint
	58,  // 75: EntrypointReply.TransiterDetails.build:type_name -> EntrypointReply.TransiterDetails.Build
	45,  // 76: System.Reference.resource:type_name -> Resource
	67,  // 77: Stop.ServiceMap.routes:type_name -> Route.Reference
	62,  // 78: Stop.HeadsignRule.stop:type_name -> Stop.Reference
	45,  // 79: Stop.Reference.resource:type_name -> Resource
	59,  // 80: Stop.Reference.system:type_name -> System.Reference
	45,  // 81: Trip.Reference.resource:type_name -> Resource
	67,  // 82: Trip.Reference.route:type_name -> Route.Reference
	62,  // 83: Trip.Reference.destination:type_name -> Stop.Reference
	65,  // 84: Trip.Reference.vehicle:type_name -> Vehicle.Reference
	45,  // 85: Vehicle.Reference.resource:type_name -> Resource
	62,  // 86: Route.ServiceMap.stops:type_name -> Stop.Reference
	45,  // 87: Route.Reference.resource:type_name -> Resource
	59,  // 88: Route.Reference.system:type_name -> System.Reference
	45,  // 89: Feed.Reference.resource:type_name -> Resource
	59,  // 90: Feed.Reference.system:type_name -> System.Reference
	45,  // 91: Agency.Reference.resource:type_name -> Resource
	59,  // 92: Agency.Reference.system:type_name -> System.Reference
	45,  // 93: Alert.Reference.resource:type_name -> Resource
	59,  // 94: Alert.Reference.system:type_name -> System.Reference
	9,   // 95: Alert.Reference.cause:type_name -> Alert.Cause
	10,  // 96: Alert.Reference.effect:type_name -> Alert.Effect
	45,  // 97: Shape.Reference.resource:type_name -> Resource
	12,  // 98: Public.Entrypoint:input_type -> EntrypointRequest
	14,  // 99: Public.ListSystems:input_type -> ListSystemsRequest
	16,  // 100: Public.GetSystem:input_type -> GetSystemRequest
	17,  // 101: Public.ListAgencies:input_type -> ListAgenciesRequest
	19,  // 102: Public.GetAgency:input_type -> GetAgencyRequest
	20,  // 103: Public.ListStops:input_type -> ListStopsRequest
	22,  // 104: Public.GetStop:input_type -> GetStopRequest
	23,  // 105: Public.ListRoutes:input_type -> ListRoutesRequest
	25,  // 106: Public.GetRoute:input_type -> GetRouteRequest
	26,  // 107: Public.ListTrips:input_type -> ListTripsRequest
	31,  // 108: Public.GetTrip:input_type -> GetTripRequest
	28,  // 109: Public.ListAlerts:input_type -> ListAlertsRequest
	30,  // 110: Public.GetAlert:input_type -> GetAlertRequest
	35,  // 111: Public.ListTransfers:input_type -> ListTransfersRequest
	37,  // 112: Public.GetTransfer:input_type -> GetTransferRequest
	32,  // 113: Public.ListFeeds:input_type -> ListFeedsRequest
	34,  // 114: Public.GetFeed:input_type -> GetFeedRequest
	38,  // 115: Public.ListVehicles:input_type -> ListVehiclesRequest
	40,  // 116: Public.GetVehicle:input_type -> GetVehicleRequest
	41,  // 117: Public.ListShapes:input_type -> ListShapesRequest
	43,  // 118: Public.GetShape:input_type -> GetShapeRequest
	13,  // 119: Public.Entrypoint:output_type -> EntrypointReply
	15,  // 120: Public.ListSystems:output_type -> ListSystemsReply
	44,  // 121: Public.GetSystem:output_type -> System
	18,  // 122: Public.ListAgencies:output_type -> ListAgenciesReply
	53,  // 123: Public.GetAgency:output_type -> Agency
	21,  // 124: Public.ListStops:output_type -> ListStopsReply
	47,  // 125: Public.GetStop:output_type -> Stop
	24,  // 126: Public.ListRoutes:output_type -> ListRoutesReply
	51,  // 127: Public.GetRoute:output_type -> Route
	27,  // 128: Public.ListTrips:output_type -> ListTripsReply
	49,  // 129: Public.GetTrip:output_type -> Trip
	29,  // 130: Public.ListAlerts:output_type -> ListAlertsReply
	54,  // 131: Public.GetAlert:output_type -> Alert
	36,  // 132: Public.ListTransfers:output_type -> ListTransfersReply
	55,  // 133: Public.GetTransfer:output_type -> Transfer
	33,  // 134: Public.ListFeeds:output_type -> ListFeedsReply
	52,  // 135: Public.GetFeed:output_type -> Feed
	39,  // 136: Public.ListVehicles:output_type -> ListVehiclesReply
	50,  // 137: Public.GetVehicle:output_type -> Vehicle
	42,  // 138: Public.ListShapes:output_type -> ListShapesReply
	56,  // 139: Public.GetShape:output_type -> Shape
...
func file_api_public_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_public_proto_msgTypes[62].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_public_proto_msgTypes[58].OneofWrappers = []interface{}{}
	file_api_public_proto_msgTypes[61].OneofWrappers = []interface{}{}
	type x struct{}
