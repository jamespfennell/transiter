...
func (q *Queries) DeleteStaleStops(ctx context.Context, arg DeleteStaleStopsParams) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, deleteStaleStops, arg.FeedPk, arg.UpdatePk)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) InsertStop(ctx context.Context, arg InsertStopParams) (int64, error) {
	row := q.db.QueryRowContext(ctx, insertStop,
		arg.ID,
		arg.SystemPk,
		arg.SourcePk,
		arg.Name,
...
func (q *Queries) MapStopPkToIdInSystem(ctx context.Context, systemPk int64) ([]MapStopPkToIdInSystemRow, error) {
	rows, err := q.db.QueryContext(ctx, mapStopPkToIdInSystem, systemPk)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdateStopParent(ctx context.Context, arg UpdateStopParentParams) error {
	_, err := q.db.ExecContext(ctx, updateStopParent, arg.ParentStopPk, arg.Pk)
	return err
}
